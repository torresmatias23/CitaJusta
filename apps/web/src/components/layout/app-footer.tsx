  ...
  return (
    <footer className="app-footer">
      <div className="page-container footer-grid">
        ...
        <div><h2>Para personas usuarias</h2><a href="/#buscar-horas">Buscar una hora</a><a href="/#como-funciona">Cómo funciona</a><Link to="/lista-de-espera">Lista de espera</Link></div>
