...
- HU-009 deberá definir zona horaria, semántica de conjuntos vacíos y compatibilidad con los campos preexistentes `acceptsAnyTime`/`acceptsWeekend` (HU-008 no los modifica), y comprobar el snapshot `entryUpdatedAtSnapshot`. No se crean candidatos, ofertas ni cambios en citas/cupos.
